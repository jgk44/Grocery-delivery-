...
import { FiArrowLeft, FiCheck, FiCreditCard, FiTruck, FiUser, FiPackage, FiMapPin, FiPhone, FiMail } from 'react-icons/fi';
import { checkoutStyles } from '../assets/dummyStyles'
// Mock CartContext for the example
const useCart = () => {
  const mockCart = [
    {
      id: "item-001",
  ...
  return {
    cart: mockCart,
    getCartTotal: () => mockCart.reduce((total, item) => total + (item.price * item.quantity), 0),
    clearCart: () => {}
  };
};
    ...
    <div className={checkoutStyles.page}>
      <div className={checkoutStyles.container}>
        ...
        <div className={checkoutStyles.header}>
          <h1 className={checkoutStyles.mainTitle}>
            Checkout
          </h1>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <label className={checkoutStyles.radioCard}>
                    ...
                    />
                    <div className="ml-3">
                      <span className="block font-medium text-emerald-100">Cash on Delivery (COD)</span>
                      <span className="block text-sm text-emerald-400">Pay when you receive your order</span>
                    </div>
                  </label>
                  ...
                  <label className={checkoutStyles.radioCard}>
                    ...
                    />
                    <div className="ml-3">
                      <span className="block font-medium text-emerald-100">Online Payment</span>
                      <span className="block text-sm text-emerald-400">Pay securely with credit/debit card or UPI</span>
                    </div>
                  </label>
                </div>
              </div>
                  ...
                  <div key={item.id} className={checkoutStyles.cartItem}>
                    ...
                    <div className="flex-grow">
                      ...
                      <div className="flex items-center justify-between mt-2">
                        ...
                        <span className="font-medium text-emerald-100">${(item.price * item.quantity).toFixed(2)}</span>
                      </div>
                    </div>
                  </div>
                ))}
            ...
            <div className="border-t border-emerald-700/50 pt-4">
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-emerald-100">${total.toFixed(2)}</span>
                </div>
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-emerald-100">${tax.toFixed(2)}</span>
                </div>
                ...
                <div className="flex justify-between pt-3 mt-3 border-t border-emerald-700/50">
                  ...
                  <span className="text-lg font-bold text-emerald-300">${grandTotal.toFixed(2)}</span>
                </div>
              </div>
              ...
              <p className="mt-4 text-center text-sm text-emerald-400">
                ...
                <a href="#" className={checkoutStyles.link}>Terms of Service</a> and{' '}
